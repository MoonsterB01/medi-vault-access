-- Phase 1: Enhanced Database Schema for Hybrid Medical Document Classification (Fixed)
...
CREATE POLICY IF NOT EXISTS "Anyone can view medical keywords" 
ON medical_keywords FOR SELECT USING (true);

CREATE POLICY IF NOT EXISTS "Admins can manage medical keywords" 
